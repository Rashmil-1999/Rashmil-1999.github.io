...
- [x] 03-05-PLAN.md — Fill Projects.astro (13 alternating-row cards with Astro <Image /> optimized covers, stretched-link a11y, name-only tech-stack pills, external-link safety triple); verify total home-page image weight < 500 KB (SECTION-06, SECTION-09, SECTION-10, STYLE-03)
