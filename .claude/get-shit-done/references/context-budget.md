...
The keys live in `.claude/settings.json` (project) or `/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/settings.json` (global) — **not** in `.planning/config.json`:
