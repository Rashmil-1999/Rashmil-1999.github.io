...
```bash
INIT=$(node "/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
