...
```bash
INIT=$(node "/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/get-shit-done/templates/spec.md.
