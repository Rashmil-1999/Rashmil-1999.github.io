...
```
Agent(
  prompt="Read /Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/get-shit-done/templates/VALIDATION.md`
