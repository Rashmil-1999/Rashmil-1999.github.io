...
- **Global scope**: `/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/notes/`)
...
2. Glob `/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/rashmilpanchani/Documents/Rashmil-1999.github.io/.claude/notes/` — works in any directory
